...
T = TypeVar("T", bound="PaginatedBookList")
...
class PaginatedBookList:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = Book.from_dict(results_item_data)

            results.append(results_item)

        paginated_book_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_book_list.additional_properties = d
        return paginated_book_list
